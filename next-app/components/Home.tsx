        ...
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          ...
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            <h1 className="my-4 text-4xl font-bold leading-tight">
              لماذا سيراميك مايوركا هو الاختيار الافضل
            </h1>
            <p className="leading-normal text-1xl md:text-2xl mb-8">
            اكتشف المزيج المثالي بين التقاليد والأناقة مع بلاط سيراميك مايوركا الرائع. مستوحاة من التراث الغني والفن النابض بالحياة في مايوركا، كل بلاط هو تحفة مصنوعة يدويًا،
             مصممة لإضفاء لمسة من دفء وسحر البحر الأبيض المتوسط ​​إلى مساحتك الخاصة
             . بفضل أنماطها المعقدة وألوانها الجريئة والحرفية المتينة، توفر بلاط مايوركا جمالًا خالدًا وجودة دائمة
             . سواء كنت تقوم بتحويل مطبخ أو حمام أو منطقة خارجية، فإن مجموعة Mayourca الخاصة بنا توفر الحل الأمثل لإضافة الأناقة والشخصية والرقي إلى منزلك.
             دع تصميماتك الداخلية تحكي قصة الثقافة والفن والأناقة مع السحر الفريد لسيراميك مايوركا.
            </p>
          </div>
          {/* Right Col */}
